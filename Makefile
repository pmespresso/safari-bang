...
deploy-polygon :; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${POLYGON_RPC_URL}  --private-key ${PRIVATE_KEY} --broadcast  -vvvv

deploy-mumbai :; @forge script script/${contract}.s.sol:Deploy${contract} --via-ir --rpc-url ${MUMBAI_RPC_URL}  --private-key ${PRIVATE_KEY} --broadcast  -vvvv
