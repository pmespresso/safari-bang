...
install :; forge install smartcontractkit/chainlink-brownie-contracts && OpenZeppelin/openzeppelin-contracts@v4.5.0 && forge install rari-capital/solmate && forge install foundry-rs/forge-std
